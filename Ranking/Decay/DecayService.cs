...
namespace Pulse.Ranking.Decay {
    public class DecayService {
        private readonly DecayConfig _decayConfig;
        ...
        public DecayService() {
            _decayConfig = new DecayConfig();
            _decayStepsCount = _decayConfig.TotalSteps;
            _decayStartAt = _decayConfig.StartAt;
            _decayEndAt = _decayConfig.EndAt;
            _decayAmounts = _decayConfig.StepAmounts;
        }
