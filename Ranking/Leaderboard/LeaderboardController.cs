...
namespace Pulse.Ranking.Leaderboard {
    ...
    public class LeaderboardController : ControllerBase {
        ...
        [HttpGet]
        [Route("")]
        public ActionResult<PagedLeaderboardModel> Leaderboard(int skip, int take) {
        ...
        [HttpGet]
        [Route("Log")]
        public ActionResult<List<LeaderboardLogModel>> Log(string username) {
            var data = _leaderboardService.GetLog(username);
            var model = _mapper.Map<List<LeaderboardLogModel>>(data);
            return model;
        }
        ...
        [HttpGet]
        [Route("restart")]
        public ActionResult<PagedLeaderboardModel> restart() {
            _leaderboardService.RemoveCache();
