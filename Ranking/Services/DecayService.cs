...
namespace Pulse.Rank.Services
{
    ...
    {
        int GetDecaySteps(int prevSteps = 0, DateTime? prevTimestamp = null, DateTime? currentTimestamp = null);
        int GetDecayValues(int prevSteps = 0, DateTime? prevTimestamp = null, DateTime? currentTimestamp = null);
        int GetDecayValue(int decayStep);
    }
