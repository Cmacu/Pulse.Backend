...
namespace Pulse.Rank.Services
{
    ...
    {
        void Reset(Core.Entities.Player player);
        void RerateAll();
        void RateMatch(Match match);
        double GetConservative(double ratingMean, double ratingDeviation);
        DivisionModel GetNewDivisionAndLevel(Division division, int level, bool isWin);
    }
    ...
    public class RatingService : IRatingService
    {
        ...
        public RatingService(DataContext context, IConfiguration configuration, IDecayService decayService)
        {
            _context = context;
