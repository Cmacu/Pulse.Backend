  ...
  public class MatchmakerService {
    ...
    public List<BatchModel> Run(
      ...
      try {
        ...
        foreach (var BatchModel in matches) {
          _matchmakerPoolSingleton.MatchPlayers(BatchModel);
          ...
          try {
            ...
            _matchmakerPoolSingleton.UnmatchPlayers(BatchModel);
            onError(BatchModel);
    ...
    public Task AddPlayer(string playerId, DateTime? joinedAt = null) {
      _matchmakerPoolSingleton.CanAddPlayer(playerId, () => {
        var playerDetails = GetMatchmakerPlayerDetails(playerId);
        if (joinedAt != null) {
