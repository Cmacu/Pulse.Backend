...
namespace Pulse.Matchmaker.Matcher {
    ...
    public class MatchmakerController : ControllerBase {
        ...
        public ActionResult<List<SeekModel>> Log() {
            return this._matchmakerService.ListPlayers();
        }
        ...
        public ActionResult<List<int>> Activity(
            ...
            return this._matchmakerLogService.ListPlayerCounts(fromDate, toDate) ?? new List<int>();
        }
        ...
        public ActionResult<List<int>> Aggregate(
            ...
            return this._matchmakerLogService.ListPlayerAggregates(fromDate, toDate) ?? new List<int>();
        }
        ...
        public ActionResult<List<SeekModel>> Add(int playerId) {
            this._matchmakerService.AddPlayer(playerId.ToString());
            return this._matchmakerService.ListPlayers();
        }
        /// <summary>
        ...
        public ActionResult<List<BatchModel>> Run() {
            ...
            var matches = this._matchmakerService.Run((match) => Task.CompletedTask, (match) => Task.CompletedTask, (match) => Task.CompletedTask);
            if (matches == null) {
                return result;
            }
